...
private:
    void recurseLayout(TasObject *parentInfo, QLayout *layout);
    void setGenericLayoutInfo(TasObject& objectInfo, QLayoutItem* item);
...
private:
    ...
    int mLayoutRecursionDepth; // for limiting recurseLayout max depth
};
